...
var file_user_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x77, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xfe, 0x01, 0x0a, 0x0b,
	0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x57, 0x0a, 0x0a, 0x43,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x50, 0x0a, 0x09, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x55, 0x73, 0x65,
	0x72, 0x12, 0x1f, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f,
	...
	0x73, 0x65, 0x72, 0x12, 0x19, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69,
	...
	0x72, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x1b, 0x5a, 0x19,
	0x6d, 0x69, 0x6e, 0x69, 0x54, 0x69, 0x6b, 0x54, 0x6f, 0x6b, 0x2f, 0x6b, 0x69, 0x74, 0x65, 0x78,
...
var file_user_proto_depIdxs = []int32{
	...
	0, // 1: user.UserService.CreateUser:input_type -> user.douyin_user_register_request
	2, // 2: user.UserService.CheckUser:input_type -> user.douyin_user_login_request
	4, // 3: user.UserService.QueryUser:input_type -> user.douyin_user_request
	1, // 4: user.UserService.CreateUser:output_type -> user.douyin_user_register_response
	3, // 5: user.UserService.CheckUser:output_type -> user.douyin_user_login_response
	5, // 6: user.UserService.QueryUser:output_type -> user.douyin_user_response
...
type UserService interface {
	CreateUser(ctx context.Context, req *DouyinUserRegisterRequest) (res *DouyinUserRegisterResponse, err error)
	CheckUser(ctx context.Context, req *DouyinUserLoginRequest) (res *DouyinUserLoginResponse, err error)
	QueryUser(ctx context.Context, req *DouyinUserRequest) (res *DouyinUserResponse, err error)
}
